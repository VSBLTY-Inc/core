...
import (
	...
	sampleAction "github.com/VSBLTY-Inc/core/examples/action"
	sampleTrigger "github.com/VSBLTY-Inc/core/examples/trigger"
...
func (ind *IndependentAction) Ref() string {
	return "github.com/VSBLTY-Inc/core/examples/action"
}
